...
public:
  explicit TilesetsSerializer(const std::string_view filepath)
  : ITypedSerializable(filepath) {}
  TilesetsSerializer(const Tilesets& tilesets, const std::string_view filepath)
  : ITypedSerializable(tilesets, filepath) {}
