...
std::tuple<bool, bool> Dialog_ChangeSkill::draw() {
  ...
  if (ImGui::BeginPopupModal(std::format("{}###ChangeSkill", m_dialogId).c_str(), &m_open, ImGuiWindowFlags_NoScrollbar | ImGuiWindowFlags_NoResize | ImGuiWindowFlags_AlwaysAutoResize)) {
    drawPickers();
