...
public:
  explicit WeaponsSerializer(const std::string_view filepath) : ITypedSerializable(filepath) {}
  WeaponsSerializer(const Weapons& weapons, const std::string_view filepath) : ITypedSerializable(weapons, filepath) {}
