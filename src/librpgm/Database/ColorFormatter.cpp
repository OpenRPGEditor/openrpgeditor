...
static std::map<EventCode, std::string_view> CommandColors{
  ...
  {EventCode::Change_Encounter, solarized::magenta},
  ...
  {EventCode::Get_on_fwsl_off_Vehicle,  solarized::maroon},
  ...
  {EventCode::Change_Map_Display_Name,  raw::deeppink},
  ...
  {EventCode::Plugin_Command_del_MV,         solarized::indigo},
  {EventCode::Plugin_Command_del_MZ,         solarized::indigo},
