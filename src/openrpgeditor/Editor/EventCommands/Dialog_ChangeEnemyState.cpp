...
std::tuple<bool, bool> Dialog_ChangeEnemyState::draw() {
  ...
  if (ImGui::BeginPopupModal(std::format("{}###ChangeEnemyState", m_dialogId).c_str(), &m_open, ImGuiWindowFlags_NoScrollbar | ImGuiWindowFlags_NoResize | ImGuiWindowFlags_AlwaysAutoResize)) {
    drawPickers();
