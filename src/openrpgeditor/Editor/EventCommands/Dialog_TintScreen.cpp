...
std::tuple<bool, bool> Dialog_TintScreen::draw() {
  ...
  if (ImGui::BeginPopupModal(std::format("{}###TintScreen", m_name).c_str(), &m_open, ImGuiWindowFlags_NoScrollbar | ImGuiWindowFlags_NoResize | ImGuiWindowFlags_AlwaysAutoResize)) {
