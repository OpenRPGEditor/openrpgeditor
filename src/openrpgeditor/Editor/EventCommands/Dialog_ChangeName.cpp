...
std::tuple<bool, bool> Dialog_ChangeName::draw() {
  ...
  if (ImGui::BeginPopupModal(std::format("{}###ChangeName", m_dialogId).c_str(), &m_open, ImGuiWindowFlags_NoScrollbar | ImGuiWindowFlags_NoResize | ImGuiWindowFlags_AlwaysAutoResize)) {
    drawPickers();
