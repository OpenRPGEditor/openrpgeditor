...
std::tuple<bool, bool> Dialog_ChangeTP::draw() {
  ...
  ImGui::SetNextWindowSize(ImVec2{254, 227}, ImGuiCond_Appearing);
  if (ImGui::BeginPopupModal(m_name.c_str(), &m_open, ImGuiWindowFlags_NoScrollbar | ImGuiWindowFlags_NoResize | ImGuiWindowFlags_AlwaysAutoResize)) {
    ...
    ImGui::BeginGroup();
    {
      ...
      if (ImGui::Button(m_comparison == 0 ? (std::format("{:04} ", m_value) + Database::instance()->actorName(m_value)).c_str() : "", ImVec2{200 - 15, 0})) {
