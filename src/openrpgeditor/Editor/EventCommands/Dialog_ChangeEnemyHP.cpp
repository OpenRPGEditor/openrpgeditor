...
std::tuple<bool, bool> Dialog_ChangeEnemyHP::draw() {
  ...
  if (ImGui::BeginPopupModal(std::format("{}###ChangeEnemyHP", m_dialogId).c_str(), &m_open, ImGuiWindowFlags_NoScrollbar | ImGuiWindowFlags_NoResize | ImGuiWindowFlags_AlwaysAutoResize)) {
    drawPickers();
