...
enum class EventCode : int {
  ...
  trENUM("Change Encounter", Change_Encounter) = 136,
  ...
  trENUM("Get on/off Vehicle", Get_on_fwsl_off_Vehicle) = 206,
  ...
  trENUM("Change Map Display Name", Change_Map_Display_Name) = 281,
  ...
  trENUM("Plugin Command", Plugin_Command_del_MV) = 356,
  trENUM("Plugin Command", Plugin_Command_del_MZ) = 357,
...
enum class MapStateType { trENUM("None", None), trENUM("Work in Progress", WorkInProgress), trENUM("Low Priority", LowPriority) };
