...
public:
  explicit StatesSerializer(const std::string_view filepath) : ITypedSerializable(filepath) {}
  StatesSerializer(const States& states, const std::string_view filepath) : ITypedSerializable(states, filepath) {}
