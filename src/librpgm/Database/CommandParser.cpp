...
std::vector<std::shared_ptr<IEventCommand>> CommandParser::parse(const json& _json) {
  ...
  while (index < parser.size()) {
    ...
    case EventCode::Event_Dummy: {
      ...
      text->indent = parser[index].value("indent", 0);
      break;
    }
    ...
    case EventCode::Show_Choices: {
      ...
      choice->indent = parser[index].value("indent", 0);
    ...
    case EventCode::When_Selected: {
      ...
      selected->indent = parser[index].value("indent", 0);
    ...
    case EventCode::When_Cancel: {
      ...
      canceled->indent = parser[index].value("indent", 0);
      break;
    }
    case EventCode::Input_Number: {
      ...
      input->indent = parser[index].value("indent", 0);
      break;
    }
    ...
    case EventCode::Conditional_Branch: {
      ...
      cond->indent = parser[index].value("indent", 0);
    ...
    case EventCode::Else: {
      ...
      c_else->indent = parser[index].value("indent", 0);
      break;
    }
    case EventCode::Loop: {
      LoopCommand* loop = dynamic_cast<LoopCommand*>(ret.emplace_back(new LoopCommand()).get());
      loop->indent = parser[index].value("indent", 0);
      break;
    }
    case EventCode::Repeat_Above: {
      ...
      repeat->indent = parser[index].value("indent", 0);
      break;
    }
    case EventCode::Break_Loop: {
      ...
      break_loop->indent = parser[index].value("indent", 0);
      break;
    }
    case EventCode::Exit_Event_Processing: {
      ...
      exit->indent = parser[index].value("indent", 0);
      break;
    }
    case EventCode::Common_Event: {
      ...
      event->indent = parser[index].value("indent", 0);
    ...
    case EventCode::Label: {
      ...
      label->indent = parser[index].value("indent", 0);
    ...
    case EventCode::Control_Switches: {
      ...
      c_switches->indent = parser[index].value("indent", 0);
    ...
    case EventCode::Control_Variables: {
      ...
      variable->indent = parser[index].value("indent", 0);
    ...
    case EventCode::Control_Self_Switch: {
      ...
      selfSw->indent = parser[index].value("indent", 0);
    ...
    case EventCode::Control_Timer: {
      ...
      timer->indent = parser[index].value("indent", 0);
    ...
    case EventCode::Change_Gold: {
      ...
      gold->indent = parser[index].value("indent", 0);
    ...
    case EventCode::Change_Items: {
      ...
      item->indent = parser[index].value("indent", 0);
    ...
    case EventCode::Change_Party_Member: {
      ...
      member->indent = parser[index].value("indent", 0);
    ...
    case EventCode::Change_Battle_BGM: {
      ...
      bgm->indent = parser[index].value("indent", 0);
    ...
    case EventCode::Change_Save_Access: {
      ...
      save->indent = parser[index].value("indent", 0);
    ...
    case EventCode::Change_Menu_Access: {
      ...
      menu->indent = parser[index].value("indent", 0);
    ...
    case EventCode::Change_Encounter_Disable: {
      ...
      encounter->indent = parser[index].value("indent", 0);
    ...
    case EventCode::Change_Formation_Access: {
      ...
      formation->indent = parser[index].value("indent", 0);
    ...
    case EventCode::Transfer_Player: {
      ...
      transfer->indent = parser[index].value("indent", 0);
    ...
    case EventCode::Scroll_Map: {
      ...
      scroll->indent = parser[index].value("indent", 0);
    ...
    case EventCode::Set_Movement_Route: {
      ...
      route->indent = parser[index].value("indent", 0);
      ...
      while (nextEventCommand() == EventCode::Movement_Route_Step) {
        ...
        tmp->indent = parser[index].value("indent", 0);
        CommandParser p;
    ...
    case EventCode::Get_On_Off_Vehicle: {
      ...
      step->indent = parser[index].value("indent", 0);
      break;
    }
    ...
    case EventCode::End: {
      ...
      end->indent = parser[index].value("indent", 0);
      break;
    }
