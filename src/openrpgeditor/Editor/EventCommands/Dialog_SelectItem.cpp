...
std::tuple<bool, bool> Dialog_SelectItem::draw() {
  ...
  if (ImGui::BeginPopupModal(std::format("{}###SelectItem", m_dialogId).c_str(), &m_open, ImGuiWindowFlags_NoScrollbar | ImGuiWindowFlags_NoResize | ImGuiWindowFlags_AlwaysAutoResize)) {
    drawPickers();
