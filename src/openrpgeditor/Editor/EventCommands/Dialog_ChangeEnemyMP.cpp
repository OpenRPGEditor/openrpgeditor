...
std::tuple<bool, bool> Dialog_ChangeEnemyMP::draw() {
  ...
  if (ImGui::BeginPopupModal(std::format("{}###ChangeEnemyMP", m_name).c_str(), &m_open, ImGuiWindowFlags_NoScrollbar | ImGuiWindowFlags_NoResize | ImGuiWindowFlags_AlwaysAutoResize)) {
    drawPickers();
