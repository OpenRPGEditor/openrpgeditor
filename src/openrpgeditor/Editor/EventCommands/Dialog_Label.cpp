...
std::tuple<bool, bool> Dialog_Label::draw() {
  ...
  if (ImGui::BeginPopupModal(std::format("{}###Label", m_dialogId).c_str(), &m_open, ImGuiWindowFlags_NoScrollbar | ImGuiWindowFlags_NoResize | ImGuiWindowFlags_AlwaysAutoResize)) {
