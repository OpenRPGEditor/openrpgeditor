...
std::tuple<bool, bool> Dialog_RecoverAll::draw() {
  ...
  if (ImGui::BeginPopupModal(std::format("{}###RecoverAll", m_dialogId).c_str(), &m_open, ImGuiWindowFlags_NoScrollbar | ImGuiWindowFlags_NoResize | ImGuiWindowFlags_AlwaysAutoResize)) {
    drawPickers();
