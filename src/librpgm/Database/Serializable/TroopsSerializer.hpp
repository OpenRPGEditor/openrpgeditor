...
public:
  explicit TroopsSerializer(const std::string_view filepath) : ITypedSerializable(filepath) {}
  TroopsSerializer(const Troops& troops, const std::string_view filepath) : ITypedSerializable(troops, filepath) {}
