...
ImVec2 GetDPIScaledSize(const ImVec2& size) { return size * GetStyle().FontScaleMain; }

float GetDPIScaledValue(const float value) { return value * GetStyle().FontScaleMain; }
