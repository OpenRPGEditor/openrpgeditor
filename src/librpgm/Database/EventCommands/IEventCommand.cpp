...
std::string IEventCommand::symbol(EventCode code) { return static_cast<int>(code) < 400 ? diamond.data() : colon.data(); }

std::string IEventCommand::indentText(const std::optional<int>& indent) {
  std::string text;
