...
std::tuple<bool, bool> Dialog_MovePicture::draw() {
  ...
  if (ImGui::BeginPopupModal(std::format("{}###MovePicture", m_dialogId).c_str(), &m_open, ImGuiWindowFlags_NoScrollbar | ImGuiWindowFlags_NoResize | ImGuiWindowFlags_AlwaysAutoResize)) {
    drawPickers();
