...
void ProjectLocationPage::draw() {
  ImGui::BeginChild("ProjectLocationPage", ImVec2(0, 0),
  ...
  if (ImGui::LabelOverLineEdit("##project_location_line_edit", "Project Base Directory Location(*)", location,
                               sizeof(location), 0.f, "Sets the directory where projects are stored")) {
