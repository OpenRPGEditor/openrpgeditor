...
void to_json(nlohmann::json& to, const Plugin& plugin) {
  to = {
      {"name", plugin.name},
...
void from_json(const nlohmann::json& from, Plugin& plugin) {
  ...
  if (from.contains("parameters")) {
    nlohmann::json parameters = from["parameters"];
