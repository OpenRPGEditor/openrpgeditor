...
std::tuple<bool, bool> Dialog_ChangeEnemyTP::draw() {
  ...
  if (ImGui::BeginPopupModal(std::format("{}###ChangeEnemyTP", m_name).c_str(), &m_open, ImGuiWindowFlags_NoScrollbar | ImGuiWindowFlags_NoResize | ImGuiWindowFlags_AlwaysAutoResize)) {
    drawPickers();
