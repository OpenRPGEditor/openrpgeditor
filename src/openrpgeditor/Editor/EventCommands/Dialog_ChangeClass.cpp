...
std::tuple<bool, bool> Dialog_ChangeClass::draw() {
  ...
  if (ImGui::BeginPopupModal(std::format("{}###ChangeClass", m_dialogId).c_str(), &m_open, ImGuiWindowFlags_NoScrollbar | ImGuiWindowFlags_NoResize | ImGuiWindowFlags_AlwaysAutoResize)) {
    drawPickers();
