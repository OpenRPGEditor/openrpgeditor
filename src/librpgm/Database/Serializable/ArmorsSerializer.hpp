...
public:
  explicit ArmorsSerializer(const std::string_view filepath)
  : ITypedSerializable(filepath) {}
  ArmorsSerializer(const Armors& armors, const std::string_view filepath)
  : ITypedSerializable(armors, filepath) {}
