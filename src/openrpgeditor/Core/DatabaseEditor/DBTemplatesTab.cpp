  ...
  ImGui::BeginChild("##orpg_templates_editor");
  {
    ...
    ImGui::BeginGroup();
    {
      ...
      if (ImGui::Button("Add", ImVec2{App::DPIHandler::scale_value(300), 0})) {
        m_templates->templates.push_back(Template("New Template" + std::to_string(m_templates->templates.size()), 0, {}, {}));
        ...
        m_selection = m_templates->templates.size() - 1;
      }
      ImGui::SameLine();
      ...
      // Template List
      if (ImGui::BeginCombo("##orpg_database_templates_templatelist",
                            m_templates->templates.at(m_selection).name.c_str())) {
        int index{0};
    ...
    ImGui::BeginGroup();
    {
      ...
      if (ImGui::BeginCombo("##orpg_templatetypes_list",
