...
public:
  explicit EnemiesSerializer(const std::string_view filepath)
  : ITypedSerializable(filepath) {}
  EnemiesSerializer(const Enemies& enemies, const std::string_view filepath)
  : ITypedSerializable(enemies, filepath) {}
