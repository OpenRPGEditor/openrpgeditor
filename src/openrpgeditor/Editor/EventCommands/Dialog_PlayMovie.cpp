...
std::tuple<bool, bool> Dialog_PlayMovie::draw() {
  ...
  if (ImGui::BeginPopupModal(std::format("{}###PlayMovie", m_dialogId).c_str(), &m_open, ImGuiWindowFlags_NoScrollbar | ImGuiWindowFlags_NoResize | ImGuiWindowFlags_AlwaysAutoResize)) {
