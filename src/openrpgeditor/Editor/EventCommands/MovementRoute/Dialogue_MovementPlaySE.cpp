#include "Dialogue_MovementPlaySE.hpp"
#include "Editor/ImGuiExt/imgui-knobs.h"
...
std::tuple<bool, bool> Dialog_MovementPlaySE::draw() {
  ...
  if (ImGui::BeginPopupModal(m_dialogId.c_str(), &m_open, ImGuiWindowFlags_NoResize | ImGuiWindowFlags_NoScrollbar | ImGuiWindowFlags_AlwaysAutoResize)) {
    ImGui::BeginGroup();
    {
