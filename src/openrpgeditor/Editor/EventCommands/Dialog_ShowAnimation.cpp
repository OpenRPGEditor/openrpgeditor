...
std::tuple<bool, bool> Dialog_ShowAnimation::draw() {
  ...
  if (ImGui::BeginPopupModal(std::format("{}###ShowAnimation", m_dialogId).c_str(), &m_open, ImGuiWindowFlags_NoScrollbar | ImGuiWindowFlags_NoResize | ImGuiWindowFlags_AlwaysAutoResize)) {
    drawPickers();
