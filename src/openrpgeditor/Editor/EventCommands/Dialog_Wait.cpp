...
std::tuple<bool, bool> Dialog_Wait::draw() {
  ...
  if (ImGui::BeginPopupModal(std::format("{}###Wait", m_dialogId).c_str(), &m_open, ImGuiWindowFlags_NoScrollbar | ImGuiWindowFlags_NoResize | ImGuiWindowFlags_AlwaysAutoResize)) {
