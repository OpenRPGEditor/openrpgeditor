...
std::tuple<bool, bool> Dialog_ChangeParameter::draw() {
  ...
  if (ImGui::BeginPopupModal(std::format("{}###ChangeParameter", m_dialogId).c_str(), &m_open, ImGuiWindowFlags_NoScrollbar | ImGuiWindowFlags_NoResize | ImGuiWindowFlags_AlwaysAutoResize)) {
    drawPickers();
