...
public:
  ...
  static CScriptJson* Create(asIScriptEngine* engine, bool v);
  static CScriptJson* Create(asIScriptEngine* engine, asINT64 v);
  static CScriptJson* Create(asIScriptEngine* engine, double v);
  static CScriptJson* Create(asIScriptEngine* engine, const std::string& v);
  static CScriptJson* Create(asIScriptEngine* engine, nlohmann::ordered_json js);
  ...
  CScriptJson* operator[](size_t idx);
  const CScriptJson* operator[](const size_t idx) const;

  void push_back(CScriptJson* value);
  ...
  nlohmann::ordered_json* js_info = NULL;
