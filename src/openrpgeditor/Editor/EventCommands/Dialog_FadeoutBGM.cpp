...
std::tuple<bool, bool> Dialog_FadeoutBGM::draw() {
  ...
  if (ImGui::BeginPopupModal(std::format("{}###FadeoutBGM", m_name).c_str(), &m_open, ImGuiWindowFlags_NoScrollbar | ImGuiWindowFlags_NoResize | ImGuiWindowFlags_AlwaysAutoResize)) {
