...
std::tuple<bool, bool> Dialog_InputNumber::draw() {
  ...
  if (ImGui::BeginPopupModal(std::format("{}###InputNumber", m_dialogId).c_str(), &m_open, ImGuiWindowFlags_NoScrollbar | ImGuiWindowFlags_NoResize | ImGuiWindowFlags_AlwaysAutoResize)) {
    drawPickers();
