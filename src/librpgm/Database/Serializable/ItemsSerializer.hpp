...
public:
  explicit ItemsSerializer(const std::string_view filepath)
  : ITypedSerializable(filepath) {}
  ItemsSerializer(const Items& items, const std::string_view filepath)
  : ITypedSerializable(items, filepath) {}
