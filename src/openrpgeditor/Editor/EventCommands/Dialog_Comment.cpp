...
std::tuple<bool, bool> Dialog_Comment::draw() {
  ...
  if (ImGui::BeginPopupModal(std::format("{}###Comment", m_dialogId).c_str(), &m_open, ImGuiWindowFlags_NoScrollbar | ImGuiWindowFlags_NoResize | ImGuiWindowFlags_AlwaysAutoResize)) {
